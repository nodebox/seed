    ...
    render(props) {
        return h(
            ...
            h(
                "span",
                {
                    class: "button seed-picker__button seed-picker__prev",
                    onClick: props.onPrevSeed
                },
                "<"
            ),
            h(
                "span",
                { class: "seed-picker__value" },
                h("input", {
            ...
            h(
                "span",
                {
                    class: "button seed-picker__button seed-picker__next",
                    onClick: props.onNextSeed
                },
                ">"
            )
        );
...
class Home extends Component {
            ...
            h(
                ...
                h(
                    ...
                    h(
                        ...
                        h(
                            "a",
                            { class: "button primary", href: "/sketch" },
                            "Get Started"
                        ),
                        h(
                            "a",
                            { class: "button", href: "/docs" },
                            "Documentation"
                        )
                    )
                ),
    ...
    renderThumb(id) {
        return h(
            ...
            h(
                "a",
                { class: "gallery__link", href: `/sketch/${id}` },
        ...
        return h(
            ...
            h(
                ...
                h(
                    ...
                    h(SeedPicker, {
                        ...
                        onSetSeed: this.onSetSeed.bind(this),
                        onPrevSeed: this.onPrevSeed.bind(this),
                        onNextSeed: this.onNextSeed.bind(this)
                    })
                ),
                h(
                    "div",
            ...
            h(
                ...
                h(
                    ...
                    h(
                        "span",
                        { className: "editor__toolbar-right" },
                        props.headerRight
                    )
                ),
                h(
        ...
        return h(
            ...
            h(
                ...
                h(
                    "button",
                    {
                        class: "button" + (state.unsaved ? " unsaved" : ""),
...
class Embed extends Component {
    render(props) {
        const link = h(
            "a",
            { href: `/sketch/${props.id}`, target: "_blank" },
            "Open in new window"
        );
        return h(
            "div",
    ...
    render(props) {
        ...
        for (const page of PAGES) {
            ...
            if (page.id === "index") {
                ...
                link = h(
                    Link,
                    {
                        class: props.page === page.id ? "active" : "",
                        href: `/docs/${page.id}`
                    },
                    page.title
                );
        ...
        return h(
            ...
            h(
                "div",
                { class: "page docs" },
                h("div", { class: "docs__nav" }, h("ul", {}, items)),
                h("div", {
                    class: "docs__body",
